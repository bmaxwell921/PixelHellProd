...
public final class GameView extends View implements Observer {
	...
	public void onDraw(Canvas canvas) {
		...
		canvas.drawText("Score: " + this.model.getScore(), width - 100, 20,
				this.brush);
		canvas.drawText("Coins: " + this.model.getCoinNumber(), width - 100,
				35, this.brush);
	}
